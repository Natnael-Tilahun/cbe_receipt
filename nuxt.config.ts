...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    public: {
      ...
      HOME_URL:
      process.env.HOME_UR || 'https://cbe-receipt.vercel.app/receipt-generator',
    },
  },
      ...
      vite: {
        define: {
          ...
          __HOME_URL__: JSON.stringify(process.env.HOME_URL) || "https://cbe-receipt.vercel.app/receipt-generator",
        },
        plugins: [
          tailwindcss(),
        ],
